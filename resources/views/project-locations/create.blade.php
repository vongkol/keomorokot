        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> New Project Location&nbsp;&nbsp;
                ...
                <div class="card-block">
                    ...
                    <form 
                        action="{{url('/admin/project-location/save')}}" 
                    ...
                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="file" name="icon" id="icon" accept="image/*" required onchange="loadFile(event)">
                            </div>
                        </div>
                        <div class="form-group row">
