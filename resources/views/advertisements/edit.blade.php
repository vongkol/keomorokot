                ...
                <div class="card-block">
                    ...
                    >
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="order" class="control-label col-sm-2 col-lg-1">Order</label>
                            <div class="col-lg-6 col-sm-8">
                                <input type="number" class="form-control" id="order" name="order" value="{{$advertisement->order}}" min="0" step="1">
                            </div>
                        </div>
                        <div class="form-group row">
