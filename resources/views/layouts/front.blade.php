...
<html lang="en">
    <head>
        ...
        <meta name="author" content="vichey">
    ...
    <div class="container-fluit header-contact">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark-t fixed-top">
            <div class="container">
    ...
    <!-- /.container -->
    <div class="container-fluit company-profile bg-dark">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-8 text-center">
                    ...
                    <aside><b class="text-white">KEO MOROKOT CONSTRUCTION </b></aside>
                    <aside><small class="text-white">  CONSTRUCTION, ENGINEERING AND DESIGN</small></aside>
      ...
      <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                <p></p>
                <aside class="text-light text-bottom">
             ...
             <div class="col-md-2 m-mobile">
                ...
                <div class="footer-page item-bottom">
                    @foreach($menus as $m)
                    <aside>
                        <a href="{{$m->url}}" class="a text-light">{{$m->name}}</a>
                    </aside>
                    @endforeach
                </div>
            </div>
             <div class="col-md-2">
                ...
                <div class="footer-page item-bottom">
                   <aside>
                        <a href="{{url('/page/4')}}" class="a text-light">Partnerships</a>
                    </aside>
                    <aside>
                        <a href="{{url('/page/5')}}" class="a text-light">Terms of Use</a>
                    </aside>
                    <aside>
                        <a href="{{url('/page/6')}}" class="a text-light">Privacy Policy</a>
                    </aside>
                </div>
            </div>
            <?php 
    ...
    <div class="mail-box">
        <a  style="text-decoration: none;" href="#" class="btn btn-link" title="Send us an email" data-toggle="modal" data-target="#exampleModalCenter">
