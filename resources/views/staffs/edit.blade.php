        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="{{url('/admin/staff/update')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                       ...
                       <div class="row">
                           <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" required autofocus name="full_name" id="full_name" value="{{$staff->full_name}}" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="position" class="control-label col-sm-4">Position <span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <input type="text" required name="position" id="position" value="{{$staff->position}}" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="section" id="section" class="form-control">
                                            <option value="staff"  {{$staff->section=='staff'?'selected':''}}>Staff</option>
                                            <option value="board" {{$staff->section=='board'?'selected':''}}>Board</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" required name="order_number" id="order_number" class="form-control" value="{{$staff->order_number}}">
                                    </div>
                                </div>
                       ...
                       <div class="row">
                           <div class="col-sm-12">
                                ...
                                <textarea name="profile" id="profile" cols="30" rows="10" class="form-control">{!!$staff->profile!!}</textarea>
                                <p><br> 
